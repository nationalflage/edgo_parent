            ...
            <table class="table-query">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input id="name" class="easyui-textbox"  type="text" data-options="required:true"/>
                        </td>
                        <th width="15%">性　别</th>
                        <td>
                    ...
                    <tr>
                        <th >呢称(长度不超5)</th>
                        <td>
                            <input id="nn" class="easyui-textbox"  type="text" validType="length[0,5]"/>
                        </td>
                         <th>邮　箱</th>
                        <td>
                            <input id="email1" class="easyui-textbox" type="text" name="email" data-options="validType:'email'"/>
                        </td>
                    </tr>
                    <tr>
                        <th>身份证号</th>
