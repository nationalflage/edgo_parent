...
<script language="javascript" type="text/javascript"> 
	...
	function myDesign01() {
		...
		if (LODOP.CVERSION) CLODOP.On_Return=function(TaskID,Value){document.getElementById('code1').value=Value;};
	...
	function myDesign02() {
		...
		if (LODOP.CVERSION) CLODOP.On_Return=function(TaskID,Value){document.getElementById('code2').value=Value;};
