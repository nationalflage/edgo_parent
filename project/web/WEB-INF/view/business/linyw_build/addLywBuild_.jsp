    ...
    <table  class="table-query">
        <tbody>
            ...
            <tr>
                <th>出生地省</th>
                <td>
						<select type="text" name="csdsheng" id="province" value="${model.csdsheng }"
								codetable="district" class="easyui-combobox hy-codeselect"
								data-options="validType:length[0,50]"/>
					</td>
				<th>出生市</th>
				<td>
					<select  class="easyui-combobox hy-codeselect" name="csdshi"
							 codetable="district" parentobject="province"
			...
			<tr>
				...
				<td>
					<c:forEach items="${lyw_ly}" var="ly">
						<input name="lywLy" type="checkbox"  id="ly${ly.code}" value="<c:out value='${ly.code}'/>"/>
						<c:out value='${ly.name}'/>
					</c:forEach>
				</td>
				<th>爱好</th>
...
<script type="text/javascript">
	...
	function save(){
		...
		$.ajax({
			type: "POST",
		   	url: "<%=basePath %>lywbuild_/doAdd.xhtml",
		   	data: data,
