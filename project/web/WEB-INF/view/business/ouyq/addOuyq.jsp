    ...
    <table  class="table-query">
        <tbody>
            <tr>
                ...
                <th>性别</th>
                <td>
                        <span id="sex" class="hy-radio"  options="男:M;女:F" checkoptions="${model.sex }" name="sex"
                              required="false" data-options="validType:length[0,50]"></span>
					</td>
			</tr>
            <tr>
                <th>年龄</th>
                <td>
                    <input type="text" id="age" name="age" class="easyui-textbox"   data-options="required:true,validType:'checkAge'"
                           value="${model.age}" style="width: 180px" />
            ...
            <tr>
                <th>出生地</th>
                <td>
                    <select class="easyui-combobox hy-codeselect" codetable="district" name="csdsheng"
                            id="csdsheng" value="${model.csdsheng}"  required="true" data-options="validType:length[0,50]"></select>
					</td>
                <th>市</th>
                <td>
                    <select class="easyui-combobox hy-codeselect" codetable="district" name="csdshi"
                            id="csdshi" parentobject="csdsheng" value="${model.csdshi}"  required="true" data-options="validType:length[0,50]"></select>
					</td>
			</tr>
            <tr>
                <th>县</th>
                <td>
                    <select class="easyui-combobox hy-codeselect" codetable="district" name="csdxian"
