...
<form id="form1">
    <table class="table-query" style="margin-top: 30px">
        ...
        <tr>
            ...
            <th>爱好</th>
            <td>
                <c:forEach items="${moyf_ah}" var="wd">
        ...
        <tr>
            <th>擅长领域</th>
            <td>
                <select class="easyui-combobox hy-codeselect" codetable="Scly_moyf" name="scly" id="scly"  style="width: 180px;">
                </select>
            </td>
        </tr>
        </tbody>
