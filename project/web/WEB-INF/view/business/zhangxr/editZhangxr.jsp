...
<form id="form1" class="query-list" method="post" action="">
        ...
        <tbody>
			...
			<tr>
                ...
                <td>
                        <input type="text" name="age" id="age" value="${model.age }"
                                class="easyui-validatebox" validType="length[1,3]" required="true"/>
                </td>
                <th>出生年月</th>
                <td>
			...
			<tr>
						<th>出生省</th>
                        <td >
                            <select class="easyui-combobox hy-codeselect" codetable="district" name="csdsheng" id="csdsheng" value="${model.csdsheng}" text="${model.csdsheng}" style="width: 180px;" ></select>
                        </td>
                <th>出生市</th>
                <td >
                    <select class="easyui-combobox hy-codeselect" codetable="district" parentobject="csdsheng" parentcode="${model.csdsheng}" name="csdshi" id="csdshi" value="${model.csdshi}" text="${model.csdshi}" style="width: 180px;" ></select>
                    </td>
			...
			<tr>
                ...
                <th>出生县</th>
                <td >
                    <select class="easyui-combobox hy-codeselect"  codetable="district" parentobject="csdshi" parentcode="${model.csdshi}" name="csdxian" id="csdxian" value="${model.csdxian}" text="${model.csdxian}" style="width: 180px;" ></select>
                </td>
                <th>具体门牌号</th>
                <td>
...
<script type="text/javascript">
	...
	function save(){
		...
		$.ajax({
			type: "POST",
		   	url: "<%=basePath %>zhangxr/doEdit.xhtml",
		   	data: data,
