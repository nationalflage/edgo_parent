...
<form id="form1" class="query-list" method="post" action="">
        ...
        <tbody>
            ...
            <tr>
                ...
                <th>具体门牌号</th>
                <td>
                        <input type="text" name="csdjdmph" id="csdjdmph" value="${model.csdjtmph }"
		...
		<tfoot>
            <tr height="100">
                <td colspan="4">
                    ...
                    <input type="button" class="btn" value="关　闭" onclick="window.parent.closeWin('修改')"/>
...
<script type="text/javascript">
	...
	function save(){
		...
		$.ajax({
			type: "POST",
		   	url: "<%=basePath %>tiany/doEdit.xhtml",
		   	data: data,
