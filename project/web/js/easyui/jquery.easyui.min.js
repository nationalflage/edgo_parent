...
$.messager.defaults=$.extend({},$.fn.dialog.defaults,{ok:"Ok",cancel:"Cancel",width:300,height:"auto",minHeight:150,modal:true,collapsible:false,minimizable:false,closable:false,
	maximizable:false,resizable:false,fn:function(){
}});
})(jQuery);
(function($){
...
$(this).tooltip("destroy");
}},rules:{email:{validator:function(_4bb){var aa=!(/([\u4E00-\u9FA5])+/.test(_4bb));
...
,url:{validator:function(_4bc){return /^((https?|http):)?\/\/(((([a-z]|\d|-|\.|_|~|[\u4e00-\u9fa5])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-z]|\d|[\u4e00-\u9fa5])|(([a-z]|\d|[\u4e00-\u9fa5])([a-z]|\d|-|\.|_|~|[\u4e00-\u9fa5])*([a-z]|\d|[\u4e00-\u9fa5])))\.)+(([a-z]|[\u4e00-\u9fa5])|(([a-z]|[\u4e00-\u9fa5])([a-z]|\d|-|\.|_|~|[\u4e00-\u9fa5])*([a-z]|[\u4e00-\u9fa5])))\.?)(:\d*)?)(\/((([a-z]|\d|-|\.|_|~|[\u4e00-\u9fa5])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-z]|\d|-|\.|_|~|[\u4e00-\u9fa5])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-z]|\d|-|\.|_|~|[\u4e00-\u9fa5])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(\#((([a-z]|\d|-|\.|_|~|[\u4e00-\u9fa5])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?$/i.test(_4bc);},message:"请输入有效的URL！"}
...
,phonenumber:{validator:function(_42h){return /^(0\d{2,3}-?)?\d{7,8}-?(\d{1,4})?$/.test(_42h);},message:"请输入有效的电话号码！"}
,cznumber:{validator:function(_42h){return /^(0\d{2,3}-)?\d{7,8}$/.test(_42h);},message:"请输入有效的传真号码！"}
,alphanum:{validator:function(_42h){
	return  /^[a-zA-Z0-9_]+$/.test(_42h);},message:"请输入字母或数字！" //\u4e00-\u9fa5
	}
,length:{validator:function(_4bd,_4be){
...
,decimal:{validator:function(_42i1,_42i2){eval("var reg1423=/^(0|[1-9]\\d{0,"+(parseInt(_42i2[0])-1).toString()+"})(\\.[0-9]{1,"+_42i2[1]+"})?$/;");return reg1423.test(_42i1);},message:"请输入有效的小数！"}
...
$.fn.textbox.defaults=$.extend({},$.fn.validatebox.defaults,{width:"180px",height:35,prompt:"",value:"",type:"text",multiline:false,icons:[],iconCls:null,iconAlign:"right",iconWidth:28,buttonText:"",buttonIcon:null,buttonAlign:"right",inputEvents:{blur:function(e){
var t=$(e.data.target);
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{showExport:false,showExportAll:false,sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:true,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:true,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:true,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:true,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowEvents:{mouseover:_64b(true),mouseout:_64b(false),click:_653,dblclick:_65d,contextmenu:_661},rowStyler:function(_7fd,_7fe){
...
$.fn.combo.defaults=$.extend({},$.fn.textbox.defaults,{inputEvents:{click:_9a7,keydown:_9ab,paste:_9ab,drop:_9ab},panelWidth:null,panelHeight:null,panelMinWidth:null,panelMaxWidth:null,panelMinHeight:null,panelMaxHeight:200,panelAlign:"left",multiple:false,selectOnNavigation:true,separator:",",hasDownArrow:true,delay:200,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
